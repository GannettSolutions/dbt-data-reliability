...
{%- macro get_anomaly_query_for_dimension_anomalies(flattened_test=none) -%}
  {{ return(adapter.dispatch('get_anomaly_query_for_dimension_anomalies', 'elementary')(flattened_test)) }}
{%- endmacro -%}
...
{% macro get_read_anomaly_scores_query(flattened_test=none) %}
    {{ return(adapter.dispatch('get_read_anomaly_scores_query', 'elementary')(flattened_test)) }}
{% endmacro %}
